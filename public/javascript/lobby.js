$(document).ready(function(){
	...
	$.ajax({
		type: 'get',
		url: 'http://192.168.0.119:8081/imageRoom/getEmp',
		data: {
	...
	$.ajax({
		type: 'get',
		url: 'http://192.168.0.119:8081/imageRoom/imageRoomLobby',
		success: function(data){
	...
	$('#roomDiv').on('click', 'a', function(event){
		...
		$.ajax({
			type : 'post',
			url : 'http://192.168.0.119:8081/imageRoom/imageRoomDelete',
			data: {
	...
	$('#createButton').click(function(){
		$.ajax({
			type: 'get',
			url: 'http://192.168.0.119:8081/imageRoom/getRoomNo',
