$(document).ready(function(){
	...
	$.ajax({
		type: 'get',
		url: 'http://106.242.203.68:8081/imageRoom/imageRoomLobby',
		success: function(data){
	...
	$('#roomDiv').on('click', 'a', function(event){
		...
		$.ajax({
			type : 'post',
			url : 'http://106.242.203.68:8081/imageRoom/imageRoomDelete',
			data: {
	...
	$('#createButton').click(function(){
		$.ajax({
			type: 'get',
			url: 'http://106.242.203.68:8081/imageRoom/getRoomNo',
